...
import { Heart, Mail, Lock, Eye, EyeOff, User, PawPrint, Star, ArrowRight, AlertCircle, Check } from "lucide-react"
          ...
          <div className="max-w-md">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 text-base leading-relaxed">
                Create an account to connect with fellow pet lovers, share your pet's journey, and discover amazing pet
                products.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-sm">Share Your Pet's Journey</h3>
                  <p className="text-xs text-gray-600">Post photos, stories, and milestones of your furry friends</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-sm">Connect with Pet Lovers</h3>
                  <p className="text-xs text-gray-600">Join communities of people who share your passion for pets</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-sm">Discover Pet Products</h3>
                  <p className="text-xs text-gray-600">Find the best toys, food, and accessories for your pets</p>
                </div>
              </div>
            </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
          <div className="w-full max-w-sm">
            ...
            <div className="lg:hidden text-center mb-6">
              ...
              <p className="text-gray-700 text-sm">Join the pawsome community today!</p>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-xl shadow-2xl border-0 p-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1">
                  <label htmlFor="username" className="block text-gray-700 font-medium text-xs">
                    Username
                  </label>
                  <div className="relative group">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                    <input
                      id="username"
                      type="text"
                ...
                <div className="space-y-1">
                  <label htmlFor="confirmPassword" className="block text-gray-700 font-medium text-xs">
                    Confirm Password
                  </label>
                  <div className="relative group">
                    <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                    <input
                      ...
                      className={`w-full pl-10 pr-10 h-10 border rounded-lg focus:ring-2 transition-all duration-200 outline-none text-sm ${
